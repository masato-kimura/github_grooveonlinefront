$(document).bind("pageshow", function() {
	...
	base.tracklist.getlist = function(offset, limit) {
		$('#about_detail_tracklist_div .review_list_ul').eq(0).css('opacity', '0');
		base.tracklist.get_ajax(offset, limit).done(function(res) {
			base.tracklist.all_count = base.tracklist.ajax_response.count;
			pagination.params.display_count = base.tracklist.ajax_response.arr_list.length;
			var html = '';
			...
			$('#about_detail_tracklist_div .review_list_ul').eq(0).animate({opacity: 1, speed: 100});
			base.page_default();
